...
public class TypingEasyThread extends Thread {
	...
	TypingEasyController easy;
	
	ArrayList<Label> lbl;
	
	public int sleep;
	
	public TypingEasyThread(ThreadGroup group, AnchorPane anchorPane, Label lblScore, ArrayList<Label> lbl, TypingEasyController easy){
		super(group,"EasyThread");
    	...
    	lbl = new ArrayList<>();
    	if(lbl.isEmpty()){
    		lbl.add(easy.lblheart1);
    		lbl.add(easy.lblheart2);
    		lbl.add(easy.lblheart3);
    	}
