...
public class TypingHardThread extends Thread {
	...
	TypingHardController hard;
	
	ArrayList<Label> lbl;
	
	public int sleep;
	
	public TypingHardThread(ThreadGroup group, AnchorPane anchorPane, Label lblScore, ArrayList<Label> lbl, TypingHardController hard){
		super(group,"HardThread");
    	...
    	lbl = new ArrayList<>();
    	if(lbl.isEmpty()){
    		lbl.add(hard.lblheart1);
    		lbl.add(hard.lblheart2);
    		lbl.add(hard.lblheart3);
    	}
